...
df_links = pd.read_excel("data/example4/raw/link_nodes.xlsx")
# print(len(df_links))
...
df_features = pd.read_excel("data/example4/raw/node_features.xlsx")
...
df_features.to_excel("data/example4/raw/node_features_count.xlsx")  # El argumento index=False evita que se incluyan los índices en el archivo
