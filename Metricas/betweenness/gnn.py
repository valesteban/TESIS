...
class GNN:
    ...
    def add_betweenness_label(self):
        ...
        betweenness_centrality_train = nx.betweenness_centrality(nx_graph_train)
        betweenness_centrality_test = nx.betweenness_centrality(nx_graph_test)
        # print(eigenvector_centrality)

        # Convertir los resultados a un tensor de PyTorch
        centrality_values = torch.tensor(list(betweenness_centrality.values())).float()
        centrality_values_train = torch.tensor(list(betweenness_centrality_train.values())).float()
        centrality_values_test = torch.tensor(list(betweenness_centrality_test.values())).float()
