...
class MyDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        df = pd.read_excel(os.path.join(self.raw_dir, '../../../data/example3/raw/node_features_count.xlsx'))
        ...
        links = df = pd.read_excel(os.path.join(self.raw_dir, '../../../data/example3/raw/link_nodes.xlsx'))
